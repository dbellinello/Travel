...
- [x] validate_itinerary.py passes (745 passed / 0 failed · 2026-06-06 13:59)
- [x] every extra populated or carries negative-finding line

Shipped: 2026-06-06 — guide_tools.py ship exit 0 (validate + verify_urls + verify_booking_links + index + US Map pin all clean)
