...
- [x] Heads Up - Extra Section.html (Pisa not in Heads Up.md — section skipped)
- [x] Claude Inspiration - Extra Section.html

## Phase 6 — Ship gate
- [x] Brain/Reference/Ship Checklist.html
- [x] validate_itinerary.py passes (704 passed / 0 failed)
- [x] every extra populated or carries negative-finding line
- [x] ship gate exit 0 (validate + verify_urls + verify_booking + index + map pin)
