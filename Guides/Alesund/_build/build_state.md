...
## Phase 4 — Per-section build (all researched ✓)
...
- [x] Cities Gotchas - Extra Section.html (does NOT ship — not in Cities Gotchas.md)
...
- Atlanterhavsparken Wikipedia H1 mismatch → no-wikipedia comment
- Sunnmøre Museum Wikipedia H1 mismatch → no-wikipedia comment
- Aksla → no English Wikipedia article
- Kongens gate → no English Wikipedia article
- BRO restaurant permanently closed → replaced with wok & Grill
