...
Source: rebuilt as sintra_v2 on 2026-05-21 — Tours Extra Section added (5 Viator / 5 GetYourGuide / 5 TripAdvisor), Day 1 rebuilt as 4 self-guided stops (tour-box stop type retired 2026-05-20), title address corrected to Rua Marechal Saldanha 13-17 per Trips.html. v1 archived to Travel/archive/sintra_v1_archived_2026-05-21.html.
...
- [x] validate_itinerary.py passes (624 passed / 0 failed · 2026-05-21 09:41)
- [x] every extra populated or carries negative-finding line
- [x] ship-gate exit 0 (link sweep 0 dead · verify_booking_links 19/0 full h1-match)
