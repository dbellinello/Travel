# Build state — Marrakech

Started: 2026-05-24
Last updated: 2026-05-24 (Session 5 — full audit fix)
...
- [x] Photos Rules.html
- [x] Links.html
- [x] Add target="_blank" to all external links
- [x] Fix "Food Delivery" section (removed non-standard extra)
- [x] Add Wikipedia links to all stops
- [x] Fix ticket links to actual products
- [x] Source and add photos to all stops
- [x] Verify train day formats and operators
...
- [x] verify_urls.py passes
- [x] verify_booking_links.py passes
- [x] brain_check.py passes
