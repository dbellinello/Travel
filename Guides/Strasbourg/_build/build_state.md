...
- [x] validate_itinerary.py passes — 745 passed / 0 failed (2026-06-06)
- [x] every extra populated or carries negative-finding line
- [x] ship gate exit 0 — verify_urls + verify_booking_links clean; guides_index + Europe Map pin present
