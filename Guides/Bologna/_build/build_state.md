...
- [x] Heads Up - Extra Section.html (city absent from Brain.md Part 3 — section does not ship)
- [x] Claude Inspiration - Extra Section.html (optional — not shipped this build)
