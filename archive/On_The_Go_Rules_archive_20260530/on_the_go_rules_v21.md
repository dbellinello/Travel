...
Created: 2026-04-30 | Updated: 2026-05-20 | Status: Active | Version: v21
...
| on\_the\_go\_rules (active) | `Rules/on_the_go_rules_v21.md` | this file |
...
- **Variety rule:** The 5 results must cover different destinations or experiences — not all the same place or theme. Mix it up: e.g. wine valley + medieval cities + coast + nature + city. If Dani specifies a destination or type, vary within that theme (different operators, different itineraries).
...
- **v21 (2026-05-20):** Variety rule added to tours — 5 results must cover different destinations or experiences, not all the same place. Mix wine valley, medieval cities, coast, nature, city, etc.
- **v20 (2026-05-20):** Removed review quotes from tour results.
- **v19 (2026-05-20):** Tours rule expanded with full detail requirements.
- **v18 (2026-05-20):** Added tours rule — 5 per platform, ratings always.
