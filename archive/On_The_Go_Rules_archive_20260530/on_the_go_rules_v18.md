...
Created: 2026-04-30 | Updated: 2026-05-20 | Status: Active | Version: v18
...
| on\_the\_go\_rules (active) | `Rules/on_the_go_rules_v18.md` | this file |
...
- Give **5 results per platform** — always with star rating and review count
- Use web search to get ratings when platform pages block direct fetch — search works, use it
- Include: tour name (clickable link) · rating · review count · duration · key highlights
- Tours depart from hotel — no need to call `user_location_v0`
- No fixed platform list — use whatever is best for the destination
...
- **v18 (2026-05-20):** Added tours rule — 5 results per platform, always with rating + review count, use web search for ratings when pages block fetch. Tours depart from hotel, no location call needed. No fixed platform list.
- **v17 (2026-05-20):** Final consolidated version. Never save mid-conversation. All rules from v11–v16 merged.
