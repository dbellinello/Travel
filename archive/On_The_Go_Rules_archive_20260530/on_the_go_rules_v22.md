...
Created: 2026-04-30 | Updated: 2026-05-20 | Status: Active | Version: v22
...
| on\_the\_go\_rules (active) | `Rules/on_the_go_rules_v22.md` | this file |
...
- 🍽 Always include 2–4 key dishes available at that venue — search the menu if needed. Only list dishes Dani can actually eat (no seafood unless Japanese).
...
- **v22 (2026-05-20):** Venue format updated — always include 2–4 key dishes (🍽 row) per restaurant. Only dishes Dani can eat. Search menu if needed.
- **v21 (2026-05-20):** Variety rule for tours — 5 results must cover different destinations.
- **v20 (2026-05-20):** Removed review quotes from tour results.
- **v19 (2026-05-20):** Tours rule expanded with full detail requirements.
- **v18 (2026-05-20):** Tours rule added — 5 per platform, ratings always.
