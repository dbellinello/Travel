...
Created: 2026-04-30 | Updated: 2026-05-20 | Status: Active | Version: v19
...
| on\_the\_go\_rules (active) | `Rules/on_the_go_rules_v19.md` | this file |
...
- Give **5 results per platform** — each entry must include ALL of the following:
  ...
  - 💬 One short review snippet from a real traveler
- Use web search to get ratings and details when platform pages block direct fetch — search works, always use it
...
- **v19 (2026-05-20):** Tours rule expanded — each result must include rating + reviews, duration, meeting point, ride time from hotel, what's covered, and a real review snippet. Web search for details when pages block fetch.
- **v18 (2026-05-20):** Added tours rule — 5 per platform, ratings always, no location call needed.
...
- **v1–v10 (2026-04-30 to 2026-05-05):** Initial versions.
