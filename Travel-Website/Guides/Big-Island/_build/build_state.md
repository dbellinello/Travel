...
- [x] Heads Up - Extra Section.html (Big Island not in Brain.md Part 3 — section not shipped)
- [x] Claude Inspiration - Extra Section.html

## Phase 6 — Ship gate
- [x] Brain/Reference/Ship Checklist.html
- [x] validate_itinerary.py passes — ✅ 698 passed / 0 failed (2026-06-11)
