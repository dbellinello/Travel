...
(function () {
  ...
  styleEl.textContent =
    ...
    /* Mobile: plain text links, natural wrap, no borders */
    '@media(max-width:600px){' +
      '.tb{padding:6px 0 4px}' +
      '.tb-links{flex-wrap:wrap;padding:0 12px;gap:2px 4px;width:100%;margin:0}' +
      '.tb-sep{display:none}' +
      '.tb a{flex:none;display:inline-flex;align-items:center;min-height:44px;' +
        'padding:2px 8px;font-size:12px;line-height:1.3;' +
        'border:none;background:transparent;font-weight:400;color:#5a5650}' +
      '.tb a.tb-active{color:' + accent + ';font-weight:500}' +
      '.tb a:hover{color:' + accent + ';background:transparent}' +
  ...
  if (curr === 'guides_index.html') {
    ...
    _wx.src = base + 'assets/weather.js?v=2';
